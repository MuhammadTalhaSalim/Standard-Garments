...
// import backgroundImg from '../assets/Uniform-Bg.jpg'; // adjust path if needed
...
// function Home() {
//   return (
//     <div className="container flex " style={backgroundStyle}>
//       <div className="content justify-center items-center flex-col h-screen mt-[120px] pl-10">
//         <h1 className="text-6xl text-white">Standard Garments</h1>
//         <p className="text-xl text-white">Smart Looks. Smart Teams.</p>
//         <button className="bg-yellow-400 text-white p-2 mt-4 rounded-md hover:bg-yellow-500">
//           Get Started
//         </button>
//       </div>
//     </div>
