...
//           <div className="h-0.5 bg-black w-24 mr-4"></div>
//           <h2 className="text-xl md:text-5xl font-bold text-black">
//             OUR SERVICES
//           </h2>
//           <div className="h-0.5 bg-black  w-24 ml-4"></div>
//         </div>
...
//           <div className="relative bg-black text-white rounded-md overflow-hidden group">
//             <img
...
//           <div className="relative rounded-md overflow-hidden group bg-black text-white group">
//             <img
...
//               <h2 className="absolute top-30 left-1/2 transform -translate-x-1/2 text-white font-bold text-xl">
//                 Winter Wear
//               </h2>
//               <button className="absolute bottom-30 bg-yellow-500 text-black px-4 py-2 rounded hover:bg-yellow-600">
//                 Read more
//               </button>
//             </div>
//           </div>
