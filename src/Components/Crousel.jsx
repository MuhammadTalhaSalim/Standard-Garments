...
//   };
//   return (
//     <div className="slider-container bg-gray-100 p-10">
//       <div className="flex flex-col items-center mb-8">
//         <div className="flex items-center justify-center mb-4">
//             <div className="h-0.5 bg-yellow-400 w-24 mr-4"></div>
//             <h2 className="text-4xl md:text-5xl font-bold text-yellow-400">
//               Our Happy Customers
//             </h2>
//             <div className="h-0.5 bg-yellow-400 w-24 ml-4"></div>
//           </div>
...
//           <div key={index}>
//             <img src={slide.image} className="w-[300px] h-[250px]" alt="" />
//           </div>
//         ))}
//       </Slider>
//     </div>
